  ...
  React.useEffect(() => {
    if (!logicGroups)
      setLogicGroups([
        {
          id: uuid(),
          rules: [{ id: uuid(), field: "", operator: "equals", value: "" }],
        },
      ]);
  }, []);
  const addGroup = () => {
      ...
      logicGroups.map((g) =>
        g.id === groupId
          ? {
              ...
              rules: [
                ...g.rules,
                { id: uuid(), field: "", operator: "equals", value: "" },
              ],
            }
          : g
      )
                ...
                <Draggable key={group.id} draggableId={group.id} index={gIndex}>
                  {(prov) => (
                    <motion.div
                      ...
                      animate={{ opacity: 1 }}
                      className="p-3 bg-white/90 rounded-lg border"
                    >
                              ...
                              >
                                {(rProv) => (
                                  <div
                                    ...
                                    className="flex gap-2 items-center bg-white p-2 rounded shadow-sm"
                                  >
                                    <div
